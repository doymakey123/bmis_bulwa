    ...
    <html>
        ...
        <body>
            <div class='header'>
                ...
                <p class='certificate-title'>OFFICE OF THE PUNONG BARANGAY</p>_
                <h2>BARANGAY CLEARANCE</h2>
            </div>
            <div class='content'>
                <p>TO WHOM IT MAY CONCERN:</p>
                <p>This is to certify that <strong>$firstName $middleName $lastName</strong>, of legal age, $civilStatus, is a resident of Barangay Bulwa, Medina, Misamis Oriental is known to be of good moral character and law-abiding citizen in the community.</p>
                <p>To certify that he/she has no derogatory and/or criminal records filed in this barangay.</p>
                <p>Issued this <strong>$day</strong> day of <strong>$month</strong>, <strong>$year</strong> at Barangay Bulwa, Medina, Misamis Oriental upon request of the interested party for whatever legal purposes it may serve.</p>
            </div>
            <div class='footer'>
                <div class='signature'>
