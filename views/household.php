...
?>
    ...
    <div class="container-fluid">
        ...
        <!-- Modal Trigger -->
        <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#brgyModal">Add Household</button>


        <table class="table table-bordered mb-4" id="householdTable" style="width: 100%">
            <thead>
                <tr>
                    <th>Seq. #</th>
        ...
        <div class="modal-content">
            <form id="addBrgyForm">
                <div class="modal-header">
                    <h5 class="modal-title" id="brgyModalLabel">Add Household Number</h5>
...
<script>
    ...
    $('#header_name_exchangeable').text('Household Information'); // Change text description
