...
<div class="container-fluid">
    ...
    <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#generateModal">Generate Clearance</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="generateModalLabel">Generate Clearance</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="certificateForm" method="POST" action="generate_clearance.php">
...
<script>
    ...
    $('#header_name_exchangeable').text('Barangay Clearance'); // Change text description
