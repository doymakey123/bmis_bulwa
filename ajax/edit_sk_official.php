...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($skofficial->update($id, $fname, $mname, $lname, $suffix, $position, $rank, $assign_area, $committee, $term, $year_elected, $status)) {
        echo json_encode(['success' => true, 'message' => 'SK official updated successfully']);

        
    } else {
        echo json_encode(['success' => false, 'message' => 'Failed to update SK official']);
